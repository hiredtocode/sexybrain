			...
			<Section>
				...
				<Content1>
					<p>
						...
						프레임워크 그리고 <Highlight>Styled Components</Highlight>를 통해
						디자인과 기능들을 구축하고 <Highlight>Redux</Highlight>를 통해
						스테이트 관리를 진행하고 있습니다. <br />
						UX/UI 디자인을 고민하며 레이아웃과 반응형 앱을 구현하고 개선을 통해
						사용자가 즐기는 앱을 만드는 것이 목적입니다. <br />
						<br />
						저는, 논리적인 사고방식으로 인해 문제를 이해하고 효율적으로 처리를
						하는 것을 좋아하고, 끊임없는 노력과 작업을 통해 효율이 좋은 기능과
						환경을 구축하여 클린 코드 베이스를 유지하는 것을 늘 고민 하고 있고,
						매일 배우며 중요한 컨셉은 직접 진행 하고 있는 프로젝트에 적용을
						함으로써 학습을 진행하고 있습니다.
						<br />
						<br />
